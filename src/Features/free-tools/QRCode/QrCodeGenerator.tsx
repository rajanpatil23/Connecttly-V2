...
// Declare QRious type for window
declare global {
  interface Window {
    QRious: any;
  }
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="rounded-3xl bg-[#B8D4F7] shadow-lg p-6 md:p-8 mb-6">
          <h1 className="text-2xl md:text-3xl font-bold mb-2 text-slate-900">{t('appTitle')}</h1>
          <p className="text-sm md:text-base text-slate-700 mb-6">{t('appDescription')}</p>
                ...
                {qrData && (
                  <div className="flex gap-4 w-full max-w-sm">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-slate-900 text-white rounded-xl hover:bg-slate-800 transition-all duration-200 font-medium shadow-lg"
                    >
