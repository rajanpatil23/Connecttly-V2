...
interface DicedHeroSectionProps {
  ...
  fontFamily?: string;
  isRTL?: boolean;
  centerElement?: React.ReactNode; // New prop for center element
}
        ...
        <div>
          <motion.span
            ...
            style={{
              ...
              fontWeight: topTextStyle?.fontWeight,
              lineHeight: topTextStyle?.lineHeight,
          ...
          <motion.p
            ...
            style={{
              ...
              fontWeight: subMainTextStyle?.fontWeight,
              lineHeight: subMainTextStyle?.lineHeight,
            }}
          >
            {subMainText}
          </motion.p>
