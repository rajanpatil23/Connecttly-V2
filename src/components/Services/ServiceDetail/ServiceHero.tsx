...
export default function ServiceHero({
  ...
  accentColor = "from-[#0074ED] to-[#79d9ff]",
}: ServiceHeroProps) {
          ...
          <div className="container px-4 py-8 lg:py-12">
            <div className="p-8 md:p-10 lg:p-12 max-w-7xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                {/* Left Visual - Image First on Mobile, Left on Desktop */}
                <motion.div
                  ...
                  animate="visible"
                >
                  <div className={`relative bg-gradient-to-br ${accentColor} rounded-[40px] p-8 md:p-12 lg:p-16 min-h-[400px] lg:min-h-[500px] flex items-center justify-center`}>
                    {/* Mockup Container */}
                ...
                {/* Right Content - Content Second on Mobile, Right on Desktop */}
                <motion.div
                  className="p-4 md:p-6 lg:p-8 order-2 lg:order-2"
