  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-8 sm:py-10">
        <ServicesRibbon 
        title="Trusted by Data-Driven Marketers"
        items={ribbonItems}
      />
      </section>
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-8 sm:pb-10">
        <div className="mx-auto max-w-6xl">
          <ServiceFeatures
                ...
                heading="Complete Attribution & Funnel Solutions"
                description="From tracking to insights, we help you understand and optimize your entire customer journey."
          ...
          <ScrollAnimatedSection bgColor="bg-[#B8E8DD]">
            <div className="px-6 sm:px-10 lg:px-14 pt-16 sm:pt-12 pb-10 sm:pb-12">
              <WhyChoose 
                ...
                heading="Why Choose Our Attribution Solutions" 
                eyebrowColor="#0A6B5E" 
                noPadding 
                noCard 
                noContainer 
        ...
        <div className="mx-auto max-w-6xl">
          <ScrollAnimatedSection bgColor="bg-[#F1F1E9]">
            <div className="px-6 sm:px-10 lg:px-14 pt-16 sm:pt-12 pb-10 sm:pb-12">
              <ProcessCards 
                eyebrow="Our Process"
                subheading="How We Implement Attribution"
                description="A proven methodology for accurate marketing attribution"
                steps={attributionProcessSteps}
                accentColor="from-[#0074ED] to-[#5B9BF8]"
              />
            </div>
          </ScrollAnimatedSection>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        <div className="mx-auto max-w-6xl">
          <PricingTable 
                plans={pricingPlans}
                heading="Choose Your Attribution Plan"
                description="Select the perfect plan for your attribution needs. All plans include multi-touch attribution and journey mapping."
                accentColor="from-[#0074ED] to-[#5B9BF8]"
              />
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        <ScrollAnimatedSection bgColor="">
          <ToolStackSection 
            ...
            description="We use the best attribution and analytics platforms to deliver accurate insights."
      ...
      <section className="py-8 sm:py-10">
        ...
        subtitle="Everything you need to know about marketing attribution and funnel analysis"
