    ...
    <div className="min-h-screen">
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-8 sm:pb-10">
        <div className="mx-auto max-w-6xl">
          <ServiceFeatures
                ...
                heading="Complete Community Management"
                description="From strategy to daily management, we handle every aspect of building and growing your community."
          ...
          <ScrollAnimatedSection bgColor="bg-[#B8E8DD]">
            <div className="px-6 sm:px-10 lg:px-14 pt-16 sm:pt-12 pb-10 sm:pb-12">
              <WhyChoose 
                ...
                heading="Why Choose Us for Community Building" 
                eyebrowColor="#0A6B5E" 
                noPadding 
                noCard 
                noContainer 
        ...
        <div className="mx-auto max-w-6xl">
          <ScrollAnimatedSection bgColor="bg-[#F1F1E9]">
            <div className="px-6 sm:px-10 lg:px-14 pt-16 sm:pt-12 pb-10 sm:pb-12">
              <ProcessCards
                eyebrow="Our Process"
                subheading="How We Build Communities"
                description="A proven methodology for launching and growing engaged communities"
                steps={communityProcessSteps}
                accentColor="from-[#0074ED] to-[#5B9BF8]"
              />
            </div>
          </ScrollAnimatedSection>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        <div className="mx-auto max-w-6xl">
          <PricingTable 
                plans={pricingPlans}
                heading="Choose Your Community Plan"
                description="Select the perfect plan for your community needs. All plans include strategy and professional moderation."
                accentColor="from-[#0074ED] to-[#5B9BF8]"
              />
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        <ScrollAnimatedSection bgColor="bg-[#F1F1E9]">
          <ToolStackSection 
            title="Powered by Leading Community Platforms"
            description="We work with the best community platforms and tools to create engaging spaces where your members can connect and thrive."
      ...
      <section className="py-8 sm:py-10">
        ...
        subtitle="Everything you need to know about our community building services"
        faqs={communityFAQs}
        accentColor="from-[#0074ED] to-[#5B9BF8]"
      />
      </section>
