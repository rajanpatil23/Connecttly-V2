  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-8 sm:py-10">
        <ServicesRibbon 
        title="Trusted by Leading Executives"
        items={ribbonItems}
      />
      </section>
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-8 sm:pb-10">
        <div className="mx-auto max-w-6xl">
          <ServiceFeatures
                ...
                heading="Complete Executive Branding Services"
                description="From strategy to execution, we build and manage your personal brand on LinkedIn."
                features={executiveLeadershipFeatures}
          ...
          <ScrollAnimatedSection bgColor="bg-[#B8E8DD]">
            <div className="px-6 sm:px-10 lg:px-14 pt-16 sm:pt-12 pb-10 sm:pb-12">
              <WhyChoose 
                ...
                heading="Why Choose Us for Executive Branding" 
                eyebrowColor="#0A6B5E" 
                noPadding 
                noCard 
                noContainer 
        ...
        <div className="mx-auto max-w-6xl">
          <ScrollAnimatedSection bgColor="bg-[#F1F1E9]">
            <div className="px-6 sm:px-10 lg:px-14 pt-16 sm:pt-12 pb-10 sm:pb-12">
              <ProcessCards 
                eyebrow="Our Process"
                subheading="How We Build Executive Brands"
                description="A proven methodology for establishing thought leadership on LinkedIn"
                steps={executiveLeadershipProcessSteps}
                accentColor="from-[#0074ED] to-[#5B9BF8]"
              />
            </div>
          </ScrollAnimatedSection>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        <div className="mx-auto max-w-6xl">
          <PricingTable 
                plans={pricingPlans}
                heading="Choose Your Executive Branding Plan"
                description="Select the perfect plan for your thought leadership goals. All plans include ghostwriting and strategy."
                accentColor="from-[#0074ED] to-[#5B9BF8]"
              />
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        <ScrollAnimatedSection bgColor="">
          <ToolStackSection 
            ...
            description="We use the best content creation and analytics tools to build and track your executive brand."
      ...
      <section className="py-8 sm:py-10">
        ...
        subtitle="Everything you need to know about our executive branding services"
